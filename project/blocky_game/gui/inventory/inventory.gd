...
func _ready():
	...
	_slots[hotbar_begin_index + 4] = _make_item(InventoryItem.TYPE_BLOCK, 12)
	_slots[hotbar_begin_index + 5] = _make_item(InventoryItem.TYPE_BLOCK, 13)
	_slots[hotbar_begin_index + 6] = _make_item(InventoryItem.TYPE_BLOCK, 14)
